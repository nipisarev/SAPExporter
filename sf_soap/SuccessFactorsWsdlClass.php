<?php
/**
 * File for SuccessFactorsWsdlClass to communicate with SOAP service
 ...
 */
/**
 * SuccessFactorsWsdlClass to communicate with SOAP service
 * 
 * @package SuccessFactors
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @version 20130813-01
 * @date 2013-08-26
 */
class SuccessFactorsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SuccessFactorsWsdlClass::setLastError()
	 * @uses SuccessFactorsWsdlClass::initSoapClient()
	 * @uses SuccessFactorsWsdlClass::initInternArrayToIterate()
	 * @uses SuccessFactorsWsdlClass::_set()
	 ...
	 * @return SuccessFactorsWsdlClass
	 */
	 ...
	 * @return SuccessFactorsWsdlClass|null
	 */
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'SuccessFactorsWsdlClass'))
			{
	 ...
	 * @uses SuccessFactorsClassMap::classMap()
	 * @uses SuccessFactorsWsdlClass::getDefaultWsdlOptions()
	 * @uses SuccessFactorsWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SuccessFactorsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SuccessFactorsClassMap::classMap();
	 ...
	 * @uses SuccessFactorsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SuccessFactorsWsdlClass::WSDL_COMPRESSION
	 * @uses SuccessFactorsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SuccessFactorsWsdlClass::WSDL_ENCODING
	 * @uses SuccessFactorsWsdlClass::WSDL_EXCPTS
	 * @uses SuccessFactorsWsdlClass::WSDL_FEATURES
	 * @uses SuccessFactorsWsdlClass::WSDL_LOGIN
	 * @uses SuccessFactorsWsdlClass::WSDL_PASSWD
	 * @uses SuccessFactorsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SuccessFactorsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SuccessFactorsWsdlClass::WSDL_TRACE
	 * @uses SuccessFactorsWsdlClass::WSDL_TYPEMAP
	 * @uses SuccessFactorsWsdlClass::WSDL_URL
	 * @uses SuccessFactorsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::getSoapClient()
	 * @uses SuccessFactorsWsdlClass::getFormatedXml()
	 ...
	 * @uses SuccessFactorsWsdlClass::getSoapClient()
	 * @uses SuccessFactorsWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses SuccessFactorsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::getInternArrayToIterate()
	 * @uses SuccessFactorsWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SuccessFactorsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SuccessFactorsWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see SuccessFactorsWsdlClass::offsetGet()
	 * @uses SuccessFactorsWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::getAttributeName()
	 * @uses SuccessFactorsWsdlClass::__toString()
	 * @uses SuccessFactorsWsdlClass::_set()
	 * @uses SuccessFactorsWsdlClass::_get()
	 * @uses SuccessFactorsWsdlClass::setInternArrayToIterate()
	 * @uses SuccessFactorsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SuccessFactorsWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses SuccessFactorsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SuccessFactorsWsdlClass::item()
	 * @uses SuccessFactorsWsdlClass::length()
	 * @return mixed
	 */
