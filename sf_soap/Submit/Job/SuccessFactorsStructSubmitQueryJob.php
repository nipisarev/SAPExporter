<?php
/**
 * File for class SuccessFactorsStructSubmitQueryJob
 ...
 */
/**
 * This class stands for SuccessFactorsStructSubmitQueryJob originally named submitQueryJob
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructSubmitQueryJob extends SuccessFactorsWsdlClass
{
	/**
	 * The queryString
	 * @var string
	...
	public $param;
	/**
	 * Constructor method for submitQueryJob
	 * @see parent::__construct()
	 * @param string $_queryString
	 * @param SuccessFactorsStructSFParameter $_param
	 * @return SuccessFactorsStructSubmitQueryJob
	 */
