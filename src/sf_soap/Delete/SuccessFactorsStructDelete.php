<?php
/**
 * File for class SuccessFactorsStructDelete
 ...
 */
/**
 * This class stands for SuccessFactorsStructDelete originally named delete
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructDelete extends SuccessFactorsWsdlClass
{
	/**
	 * The type
	 * @var string
	 ...
	 * @return SuccessFactorsStructDelete
	 */
