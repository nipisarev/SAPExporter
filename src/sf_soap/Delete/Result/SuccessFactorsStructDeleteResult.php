<?php
/**
 * File for class SuccessFactorsStructDeleteResult
 ...
 */
/**
 * This class stands for SuccessFactorsStructDeleteResult originally named DeleteResult
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructDeleteResult extends SuccessFactorsWsdlClass
{
	/**
	 * The jobStatus
	 * @var string
