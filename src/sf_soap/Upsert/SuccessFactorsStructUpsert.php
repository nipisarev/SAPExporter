<?php
/**
 * File for class SuccessFactorsStructUpsert
 ...
 */
/**
 * This class stands for SuccessFactorsStructUpsert originally named upsert
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructUpsert extends SuccessFactorsWsdlClass
{
	/**
	 * The type
	 * @var string
	 ...
	 * @return SuccessFactorsStructUpsert
	 */
