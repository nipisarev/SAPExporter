<?php
/**
 * File for class SuccessFactorsStructCancelJob
 ...
 */
/**
 * This class stands for SuccessFactorsStructCancelJob originally named cancelJob
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructCancelJob extends SuccessFactorsWsdlClass
{
	/**
	 * The taskId
	 * @var string
	 ...
	 * @return SuccessFactorsStructCancelJob
	 */
