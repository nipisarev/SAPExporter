<?php
/**
 * File for class SuccessFactorsStructCancelJobResponse
 ...
 */
/**
 * This class stands for SuccessFactorsStructCancelJobResponse originally named cancelJobResponse
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructCancelJobResponse extends SuccessFactorsWsdlClass
{
	/**
	 * The result
