<?php
/**
 * File for class SuccessFactorsStructDescribeSFObjectsEx
 ...
 */
/**
 * This class stands for SuccessFactorsStructDescribeSFObjectsEx originally named describeSFObjectsEx
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructDescribeSFObjectsEx extends SuccessFactorsWsdlClass
{
	/**
	 * The type
	 * Meta informations extracted from the WSDL
	...
	public $param;
	/**
	 * Constructor method for describeSFObjectsEx
	 * @see parent::__construct()
	 * @param string $_type
	 * @param SuccessFactorsStructSFParameter $_param
	 * @return SuccessFactorsStructDescribeSFObjectsEx
	 */
