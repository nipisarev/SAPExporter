<?php
/**
 * File for class SuccessFactorsStructQueryResponse
 ...
 */
/**
 * This class stands for SuccessFactorsStructQueryResponse originally named queryResponse
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructQueryResponse extends SuccessFactorsWsdlClass
{
	/**
	 * The result
