<?php
/**
 * File for class SuccessFactorsStructUpdate
 ...
 */
/**
 * This class stands for SuccessFactorsStructUpdate originally named update
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructUpdate extends SuccessFactorsWsdlClass
{
	/**
	 * The type
	 * @var string
