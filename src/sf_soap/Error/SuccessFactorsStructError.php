<?php
/**
 * File for class SuccessFactorsStructError
 ...
 */
/**
 * This class stands for SuccessFactorsStructError originally named Error
 ...
 * @date 2013-08-26
 */
class SuccessFactorsStructError extends SuccessFactorsWsdlClass
{
	/**
	 * The errorCode
	 * @var string
